...
func (m *mockTodoManager) Create(chatCtx iface.ChatContextInterface, content string, opts ...interface{}) (*storage.Todo, error) {
	return nil, nil
}

func (m *mockTodoManager) Get(chatCtx iface.ChatContextInterface, id string) (*storage.Todo, error) {
	return nil, nil
}

func (m *mockTodoManager) List(chatCtx iface.ChatContextInterface) ([]*storage.Todo, error) {
	return nil, nil
}

func (m *mockTodoManager) Update(chatCtx iface.ChatContextInterface, id string, updates map[string]any) (*storage.Todo, error) {
	return nil, nil
}
...
func (m *mockTodoManager) Start(chatCtx iface.ChatContextInterface, id string) (*storage.Todo, error) {
	return nil, nil
}

func (m *mockTodoManager) Complete(chatCtx iface.ChatContextInterface, id string, result string) (*storage.Todo, error) {
	return nil, nil
}

func (m *mockTodoManager) Fail(chatCtx iface.ChatContextInterface, id string, reason string) (*storage.Todo, error) {
	return nil, nil
}

func (m *mockTodoManager) Block(chatCtx iface.ChatContextInterface, id string, reason string) (*storage.Todo, error) {
	return nil, nil
}

func (m *mockTodoManager) Unblock(chatCtx iface.ChatContextInterface, id string) (*storage.Todo, error) {
	return nil, nil
}

func (m *mockTodoManager) GetAvailableTodos(chatCtx iface.ChatContextInterface) ([]*storage.Todo, error) {
	return nil, nil
}
...
func (m *mockToolManagerForEngine) GetToolDefs() []llm.ToolDef {
	return m.tools
}
...
func TestAgentEngineSystemPrompt(t *testing.T) {
	...
	chatCtxForChat := chatcontext.NewChatContext(ctx, session.ID.String(), "coding-agent")
	err = engine.Chat(chatCtxForChat, "Hello")
	require.NoError(t, err)
...
// TestTodoLoopFix removed: requires server-side gorm/todo dependencies
// This test lives in server/internal/agent/ instead.
...
func TestDepthRejection(t *testing.T) {
	ctx := context.Background()
	chatCtx := chatcontext.NewChatContext(ctx, "test-depth-session", "test-agent").WithDepth(3)
